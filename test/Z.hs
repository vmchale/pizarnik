...
main = defaultMain $
    testGroup "unit"
        ...
        , testGroup "ty"
            ...
            : tE "test/data/univL.piz" "1:5: could not match ‘Int’ against ‘a’"
            : tE "test/data/univR.piz" "1:8: could not match ‘Int’ against ‘a’"
            : tE "test/examples/errorHierarchy.piz" "?"
            : tE "test/data/badBool.piz" "3:12: failed to unify ‘{True}’ with ‘{True ⊕ False}’"
            : tE "test/data/badBool2.piz" "3:12: failed to unify ‘{False}’ with ‘{True ⊕ False}’"
